...
class _QuestionPageState extends State<QuestionPage> {
  ...
  Future<void> _bottomSheet(BuildContext context, QuizState state) async {
    ...
    // Validate that the question has been answered
    bool isAnswered = false;
    if (widget.question.type == 'Open Answer') {
      isAnswered = state.openAnswers[widget.questionIndex].trim().isNotEmpty;
    } else if (widget.question.type == 'Single Choice') {
      isAnswered = state.singleChoiceAnswers[widget.questionIndex] != null;
    } else if (widget.question.type == 'Multiple Choice') {
      isAnswered = state.multipleChoiceAnswers[widget.questionIndex].isNotEmpty;
    }

    if (!isAnswered) {
      // Show a warning if the question is not answered
